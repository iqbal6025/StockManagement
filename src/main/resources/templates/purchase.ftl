  ...
  <body>
   ...
   <table class="table table-striped table-hover">
     ...
     <tr>
         ...
         <td>${purchase.purchaseOrderStatus?cap_first}</td>
         <td>${purchase.totalAmount}</td>
         <td>${purchase.invoice_status}</td>
         <td>${purchase.supplierBusinessName?cap_first}</td>
     </tr>
     </#list>
    </table>
    </div>
     ...
     <script>
          document.getElementsByTagName('button')[2].setAttribute("class","active");
     </script>
